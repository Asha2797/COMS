...
<title>CMS</title>
	...
	<div class="container">
			<div class="row main">
				...
				<h3> AUTHOR LOGIN FORM </h3>
				
		<form action="" method="POST">
		
			<div class="form-group">
			<label for="aut_id" class="cols-sm-2 control-label">  Author ID </label>
			<div class="cols-sm-10">
				<div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
			<input type="text" id="aut_id"  name="aut_id" placeholder="Enter the author id" class="form-control input-lg"
		...
		<div class="form-group ">
						<center><a href="auth_home.html" type="button" id="button" class="btn  btn-sm ">Home</a></center>	
						</div></div></div>			
...
$ret= mysqli_query($conn, "SELECT * FROM author WHERE auth_id='".$_POST['aut_id']."' and password='$password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
header("location:auth_main.php?auth_id=$auth_id");
exit();
}
else
{?>
